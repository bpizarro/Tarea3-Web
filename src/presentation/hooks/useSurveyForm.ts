...
import { submitSurveyUseCase, type FormData } from '@domain/usecases/SurveyUseCases'
import { SurveyRepositoryImpl } from '@data/repositories/SurveyRepositoryImpl'

/** Instancia del repositorio (inyección en el hook — adecuado para este tamaño de proyecto) */
